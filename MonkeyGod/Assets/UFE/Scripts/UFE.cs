...
public class UFE : MonoBehaviour {
	...
	public  GlobalInfo UFE_Config;
	 public static bool lifepointsCheck;
	 public static float updatedLifePoints;
	 public static bool diamondCheck = false;
	 public static bool videoCheck = false;
	...
	[HideInInspector]public static GameObject controlFreakPrefab;
	...
	public static void StartUpdateWeaponScreen(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, false, fadeTime/2f, 0, () => { UFE._StartUpdateWeaponScreen(fadeTime/2f); });
	}
	...
	protected void Update(){
		...
		try{
			if (config.player1Character.currentLifePoints == 0 || config.player2Character.currentLifePoints == 0) {
	...
	private static void _StartGame(float fadeTime){
		...
		UFE.config.player1Character.lifePoints = (int)(PlayerPrefs.GetFloat ("HEALTH"));
		UFE.config.player1Character.currentLifePoints = (float)UFE.config.player1Character.lifePoints;

		// update energy
		if(diamondCheck == true)
		{
			UFE.config.player1Character.lifePoints = (int)(PlayerPrefs.GetFloat ("HEALTH"))+250;
			diamondCheck = false;
		}
		else
		{
	...
	private static void _StartUpdateWeaponScreen(float fadeTime){
		if (Network.peerType != NetworkPeerType.Disconnected) Network.Disconnect();
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
	...
	public static AsyncOperation TrainingRoom_async;
	void Start ()
	{
//		Debug.Log ("Hello");

//		TrainingRoom_async=Application.LoadLevelAsync ("LoadingScene");
//		TrainingRoom_async.allowSceneActivation = false;
...
//				UFE.battleGUI.OnHide();
//				GameObject.Destroy(UFE.battleGUI.gameObject);
//			if(TrainingRoom_async.isDone)
//			{
				UFE.EndGame();
//			foreach (GameObject o in UFE.FindObjectsOfType<GameObject>()) {
//				Destroy(o);
//				}
//			}
			int checkResult = PlayerPrefs.GetInt("LankiniFight");
			if(checkResult == 1)
			{
				...
				PlayerPrefs.SetInt("FIGHTRESULT",2);
				Application.LoadLevel("PreFightCutScene");
			}
			else if(checkResult == 2)
			{
				PlayerPrefs.SetInt("FIGHTRESULT",1);
				PlayerPrefs.SetInt("LankiniFight",0);
				Application.LoadLevel("PreFightCutScene");
			}
			else if(checkResult == 3)
			{
				PlayerPrefs.SetInt("FIGHTRESULT",0);
				PlayerPrefs.SetInt("LankiniFight",0);
				Application.LoadLevel("PreFightCutScene");
			}
			...
			{
				PlayerPrefs.SetInt("LankiniFight",0);
				Application.LoadLevelAsync("HanSitaConver");
...
//		StartCoroutine(Main_Start ());
	}
//	private AsyncOperation aO1;
//	IEnumerator Main_Start(){
//		aO1 = 
//		yield return aO1;
//	}
	public static void updateEnergy(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.updateScreen);
	}
	public static void Warning(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp16);
	}
	public static void WarningLevel2(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp15);
	}
	public static void WarningLevel3(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp14);
	}
	public static void weaponPopup(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup);
	}
	public static void secondPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp);
	}
	public static void seethaPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup2);
	}
	public static void thirdPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp3);
	}
	public static void fourthPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp4);
	}
	public static void fifthPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp5);
	}
	public static void tryAgainPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp6);
	}
	public static void treemanWarning2Popup(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp7);
	}
	public static void treemanWarning3Popup(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp8);
	}
	public static void treemanWarning4Popup(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp9);
	}
//	public static void RakshasWarningPopup(float fadeTime){
//		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
//		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp10);
//	}
	public static void MahiravanaWarningPopup(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp11);
	}
	public static void lankiniWarningPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp12);
	}
	public static void indrajithWarningPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.secondPopUp13);
	}
	public static void seethaWarning(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup3);
	}
	public static void ramaWarning(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup4);
	}
	public static void armourPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup5);
	}
	public static void level2BuyGadhaPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup6);
	}
	public static void level2BuyblueArmourPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup7);
	}
	public static void level2BuyblackGadhaPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup8);
	}
	public static void level2BuyredArmourPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup9);
	}
	public static void level2BuypurpleArmourPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup10);
	}
	public static void level3Buygadha1PopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup11);
	}
	public static void level3Buygadha2PopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup12);
	}
	public static void level3BuyarmourPopUp(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.weaponPopup13);
	}
	public static void storeUI(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.storeScreen);
	}
	public static void successUI(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.successUI);
	}
	public static void waitUI(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.waitUI);
	}
	public static void alertUI(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.alertMsg);
	}
	public static void timerUI(float fadeTime){
		CameraFade.StartAlphaFade(Color.black, true, fadeTime);
		UFE.ShowScreen (UFE.config.gameGUI.timerUI);
	}
	#endregion
}