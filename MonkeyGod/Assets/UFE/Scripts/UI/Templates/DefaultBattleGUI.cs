...
public class DefaultBattleGUI : BattleGUI{
	...
	public override void DoFixedUpdate (){
		...
		if (this.isRunning){
			...
			if (this.player1.targetLife > UFE.config.player1Character.currentLifePoints){
				if (this.player1.character.characterPrefab.name.Equals ("NewHanman10")) 
				{
				if(UFE.config.player1Character.currentLifePoints<=50)
					{
					}
					else{
	...
	private string secondfightcoin="75";
	private string secondfightdiamond="2";

	private string thirdfightcoin="115";
	private string thirdfightdiamond="3";

	private string fourthfightcoin="150";
	private string fourthfightdiamond="4";

	private string fifthfightcoin="190";
	private string fifthfightdiamond="5";
...
//					Debug.Log(key);
//					accessData(j);
					if(key.Equals("Secondfightcoin")){
						secondfightcoin	= obj.GetField("Secondfightcoin").ToString();
						secondfightcoin=secondfightcoin.Replace("\"",string.Empty).Trim();
//						Debug.Log(secondfightcoin);
					}
					else if(key.Equals("Secondfightdiamond")){
						secondfightdiamond = obj.GetField("Secondfightdiamond").ToString();
						secondfightdiamond = secondfightdiamond.Replace("\"",string.Empty).Trim();
//						Debug.Log(secondfightdiamond);
					}

					if(key.Equals("Thirdfightcoin")){
						thirdfightcoin	= obj.GetField("Thirdfightcoin").ToString();
						thirdfightcoin=thirdfightcoin.Replace("\"",string.Empty).Trim();
//						Debug.Log(thirdfightcoin);
					}
					else if(key.Equals("Thirdfightdiamond")){
						thirdfightdiamond = obj.GetField("Thirdfightdiamond").ToString();
						thirdfightdiamond = thirdfightdiamond.Replace("\"",string.Empty).Trim();
//						Debug.Log(thirdfightdiamond);
					}

					if(key.Equals("Fourthfightcoin")){
						fourthfightcoin	= obj.GetField("Fourthfightcoin").ToString();
						fourthfightcoin=fourthfightcoin.Replace("\"",string.Empty).Trim();
//						Debug.Log(fourthfightcoin);
					}
					else if(key.Equals("Fourthfightdiamond")){
						fourthfightdiamond = obj.GetField("Fourthfightdiamond").ToString();
						fourthfightdiamond = fourthfightdiamond.Replace("\"",string.Empty).Trim();
//						Debug.Log(fourthfightdiamond);
					}

					if(key.Equals("Fifthfightcoin")){
						fifthfightcoin	= obj.GetField("Fifthfightcoin").ToString();
						fifthfightcoin=fifthfightcoin.Replace("\"",string.Empty).Trim();
//						Debug.Log(fifthfightcoin);
					}
					else if(key.Equals("Fifthfightdiamond")){
						fifthfightdiamond = obj.GetField("Fifthfightdiamond").ToString();
						fifthfightdiamond = fifthfightdiamond.Replace("\"",string.Empty).Trim();
//						Debug.Log(fifthfightdiamond);
					}
				}
				break;
	...
	protected override void OnGamePaused (bool isPaused){
		...
		if (this.pauseScreen != null){
			if (isPaused){
				if(pauseOnce == true)
				{
					switch(IntroScreen.characterValue)
					{
					// level 1 fight cases
						case 2 : 
							if(WeaponPopUp.buygadha2 == true){
								...
								UFE.seethaPopUp(0f);
								coinsText = GameObject.Find("Seetha07(Clone)").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								coinsText.text = secondfightcoin;
								diamondText = GameObject.Find("Seetha07(Clone)").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								diamondText.text = "  "+ secondfightdiamond;
								editText = GameObject.Find("Seetha07(Clone)").transform.GetChild(4).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								editText.text = "wait";
								pauseOnce = false;
								UFE.EndGame();
							}
						...
						case 3 : 
							if(WeaponPopUp.buyArmour1 == true){
								...
								UFE.seethaWarning(0f);
								coinsText = GameObject.Find("Seetha09(Clone)").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								coinsText.text = thirdfightcoin;
								diamondText = GameObject.Find("Seetha09(Clone)").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								diamondText.text = "  "+thirdfightdiamond;
								editText = GameObject.Find("Seetha09(Clone)").transform.GetChild(4).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								editText.text = "wait";
								pauseOnce = false;
								UFE.EndGame();
							}
						...
						case 4 : 
							if(WeaponPopUp.buygadha3 == true){
								...
								UFE.ramaWarning(0f);
								coinsText = GameObject.Find("Rama11(Clone)").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								coinsText.text =fourthfightcoin;
								diamondText = GameObject.Find("Rama11(Clone)").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								diamondText.text = "  "+fourthfightdiamond;
								editText = GameObject.Find("Rama11(Clone)").transform.GetChild(4).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								editText.text = "wait";
								pauseOnce = false;
								UFE.EndGame();
							}
						...
						case 5 : 
							if(WeaponPopUp.buyArmour2 == true){
								...
								UFE.armourPopUp(0f);
								coinsText = GameObject.Find("Seetha13(Clone)").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								coinsText.text =fifthfightcoin;
								diamondText = GameObject.Find("Seetha13(Clone)").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								diamondText.text = "  "+fifthfightdiamond;
								editText = GameObject.Find("Seetha13(Clone)").transform.GetChild(4).GetChild(0).GetComponent<UnityEngine.UI.Text>();
								editText.text = "wait";
								pauseOnce = false;
								UFE.EndGame();
							}
					...
					case 10 :
						if(WeaponPopUp.level2buygadha == true)
						{
							...
							UFE.level2BuyGadhaPopUp(0f);
							coinsText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							coinsText.text = "2";
							diamondText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							diamondText.text = "2";
							editText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(4).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							editText.text = "wait";
							pauseOnce = false;
							UFE.EndGame();
						}
					...
					case 11 :
						if(WeaponPopUp.level2buygadha == true)
						{
							...
							UFE.level2BuyblueArmourPopUp(0f);
							coinsText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							coinsText.text = "2";
							diamondText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							diamondText.text = "2";
					...
					case 12 :
						if(WeaponPopUp.level2buygadha == true)
						{
							...
							UFE.level2BuyblackGadhaPopUp(0f);
							coinsText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							coinsText.text = "2";
							diamondText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							diamondText.text = "2";
					...
					case 13 :
						if(WeaponPopUp.level2buygadha == true)
						{
							...
							UFE.level2BuyredArmourPopUp(0f);
							coinsText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							coinsText.text = "2";
							diamondText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							diamondText.text = "2";
					...
					case 18 :
						if(WeaponPopUp.level2buyarmour3 == true)
						{
							...
							UFE.level2BuypurpleArmourPopUp(0f);
							coinsText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(2).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							coinsText.text = "2";
							diamondText = GameObject.FindGameObjectWithTag("level2BuyGadha").transform.GetChild(3).GetChild(0).GetComponent<UnityEngine.UI.Text>();
							diamondText.text = "2";
