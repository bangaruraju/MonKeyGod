...
public class ArmourPopUp : UFEScreen {
	public static bool boughtWeapon = false;
...
//			boughtWeapon = true;
//			RamaWarning.buynewWeaponOnce = false;
...
//				UFE.StartGame (0);
//			}
//		} else if (SeethaWarning.buynewWeaponOnce == true) {
//			CharacterInfo[] selectableCharacters = UFE.GetVersusModeSelectableCharacters ();
...
//				UFE.StartGame (0);
//			}
//		} else if (RamaWarning.buynewWeaponOnce == true) {
//			CharacterInfo[] selectableCharacters = UFE.GetVersusModeSelectableCharacters ();
//			CharacterInfo character1 = selectableCharacters [6];
//			UFE.SetPlayer (1, character1);
//			if (newLife <= 600 / 2) {
